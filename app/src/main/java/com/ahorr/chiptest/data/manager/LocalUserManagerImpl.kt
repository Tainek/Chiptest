package com.ahorr.chiptest.data.manager
...
import com.ahorr.chiptest.util.Constants.USER_SETTINGS
...
class LocalUserManagerImpl(private val context: Context) : LocalUserManager {
    ...
    override fun readAppEntry(): Flow<Boolean> {
        return context.dataStore.data.map { preferences -> preferences[PreferencesKeys.APP_ENTRY] == true }
    }
